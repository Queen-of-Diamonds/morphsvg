  ...
  <div class="alphabet">
    ...
    >
      ...
      <polygon
        id="triangle"
        class="st1"
        points="241.057,242.158 283.557,157.158 326.057,242.158 "
      />
      <g id="letters">
        <path
          id="a"
          class="st2"
          d="M222.838,264.526c0-0.68,0.203-1.632,0.612-2.856l48.373-134.098c0.679-2.175,3.399-3.266,8.164-3.266
        ...
        <path
          id="b"
          class="st2"
          d="M364.571,262.89V132.263c0-4.082,2.041-6.123,6.123-6.123h36.533c14.829,0,26.159,3.266,33.984,9.797
    ...
    M382.532,187.78h23.675c8.164,0,14.901-2.312,20.207-6.94c5.306-4.624,7.961-10.511,7.961-17.655
        ...
        <path
          id="c"
          class="st2"
          d="M471.736,197.659c0-48.44,22.043-72.661,66.128-72.661c9.799,0,18.744,1.397,26.84,4.185
...
export default {
  ...
  methods: {
    onLoaded() {
      ...
      console.log(
        "🚀 ~ file: Alphabet.vue ~ line 30 ~ onLoaded ~ this.svgHasLoaded",
        this.svgHasLoaded
      );
      // const tl = gsap.timeline({repeat:-1, repeatDelay:0.3, yoyo:true})

      // console.log(MorphSVGPlugin.convertToPath("circle, rect, polygon"));
